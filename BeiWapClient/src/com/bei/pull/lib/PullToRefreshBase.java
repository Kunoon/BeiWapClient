...
import com.bei.pull.lib.internal.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	static final float FRICTION = 2.0f;	// 惯性

	static final int PULL_TO_REFRESH = 0x0;	// 拉刷新
	static final int RELEASE_TO_REFRESH = 0x1;	// 释放来刷新
	static final int REFRESHING = 0x2;	// 无刷新
	static final int MANUAL_REFRESHING = 0x3;	// 手动无刷新

	public static final int MODE_PULL_DOWN_TO_REFRESH = 0x1;	// 下拉刷新模式
	public static final int MODE_PULL_UP_TO_REFRESH = 0x2;	// 上拉刷新模式
	public static final int MODE_BOTH = 0x3;	// 上拉下拉同时存在
