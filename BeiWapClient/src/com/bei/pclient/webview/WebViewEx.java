...
public class WebViewEx extends WebView {
    ...
    private String genJavascriptInterfacesString() {
        ...
        /*
         * 要注入的JS的格式，其中XXX为注入的对象的方法名，例如注入的对象中有�?��方法A，那么这个XXX就是A
         * 如果这个对象中有多个方法，则会注册多个window.XXX_js_interface_name块，我们是用反射的方法遍�?
         * 注入对象中的�?��带有@JavaScripterInterface标注的方�?
         * 
    ...
    private void createJsMethod(String interfaceName, Object obj, StringBuilder script) {
        ...
        for (Method method : methods) {
            ...
            // 过滤掉Object类的方法，包括getClass()方法，因为在Js中就是�?过getClass()方法来得到Runtime实例
